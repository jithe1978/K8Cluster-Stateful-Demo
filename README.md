# K8Cluster-Stateful-Demo  ---> app.mldevops.org hosted in Route53 and built on AWS EKS, this frontend client reactjs and backend api with Altas Mongo db for testing stateful session in Kubernetes Cluster.
